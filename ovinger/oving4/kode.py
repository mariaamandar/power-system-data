...
plt.title("Produksjon og forbruk i 2026")
plt.xlabel("Tid")
plt.ylabel("Produksjon og forbruk")
plt.grid()
plt.legend(["Produksjon", "Forbruk"])
#plt.show()
plt.savefig("ovinger/oving4/produksjon_forbruk_2026.png")

df.plot(y=["Production", "Consumption", "Netto"],figsize=(10, 5))
plt.title("Produksjon, forbruk og nettoeffekt i 2026")
plt.xlabel("Tid")
plt.ylabel("Produksjon, forbruk og nettoeffekt")
plt.grid()
plt.legend(["Produksjon", "Forbruk", "Nettoeffekt"])
#plt.show()
plt.savefig("ovinger/oving4/produksjon_forbruk_netto_2026.png")