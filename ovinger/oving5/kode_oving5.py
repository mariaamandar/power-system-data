...
df = pd.read_csv("ovinger/oving5/consumption_datacenter_per_mba_hour.csv", sep=";",
    decimal=",")
...
dogn_profil = df_NO2.loc["2026-01-02", "VOLUM_KWH"] # fordi det er per time, så blir 1KWh per time 
